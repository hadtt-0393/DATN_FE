...
const HotelFAQ = ({ type }: HotelFAQProps) => {
  const faqData = [
    {
      question: `How do I find cheap ${type.toLowerCase()} on Best Booking?`,
    ...
    {
      question: `Where can I find ${type.toLowerCase()} deals on Best Booking?`,
    ...
    {
      question: `How many ${type.toLowerCase()} are listed on Best Booking?`,
    ...
    {
      question: `How do I search for a ${type.toLowerCase()} on Best Booking?`,
    ...
    {
      question: `How do I find cheap last minute ${type.toLowerCase()} on Best Booking?`,
    ...
    {
      question: `Why can I trust Best Booking's ${type.toLowerCase()} review?`,
  ...
  return (
    <div className={styles['hotel-faq']}>
      <div className={styles['hotel-faq__title']}>
        FAQs about {type.toLowerCase()} on Best Booking
      </div>
