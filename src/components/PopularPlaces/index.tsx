            ...
            <Box width="100%" display="flex" flexDirection="column" m="60px auto" >
                ...
                <Box sx={{ height: "900px", flex: 1, width: "95%", margin: "10px auto" }}>
                    <Grid container  spacing={3}>
                        <Grid item xs={4}>
                            <Box display="flex" alignItems="center" justifyContent="center" height="460px"  overflow="hidden" borderRadius="10px" position="relative" onClick={() => navigate("/search-results")}>
                        ...
                        <Grid item xs={8}>
                            <Box display="flex" alignItems="center" justifyContent="center" height="410px"  overflow="hidden" borderRadius="10px" position="relative" onClick={() => navigate("/search-results")}>
                        ...
                        <Grid item xs={4}>
                            <Box display="flex" alignItems="center" justifyContent="center" height="415px"  overflow="hidden" borderRadius="10px" position="relative" onClick={() => navigate("/search-results")} >
                        ...
                        <Grid item xs={4}>
                            <Box display="flex" alignItems="center" justifyContent="center" height="420px" overflow="hidden" borderRadius="10px" marginTop="-50px" position="relative" onClick={() => navigate("/search-results")} >
