            ...
            <Box width="100%" display="flex" flexDirection="column" m="60px auto" >
                ...
                <Box sx={{ height: "900px", flex: 1, width: "95%", margin: "10px auto" }}>
                    <Grid container >
                        ...
                        <Grid xs={8}>
                            <Box display="flex" alignItems="center" justifyContent="center" height="410px" marginLeft="10px" overflow="hidden" borderRadius="10px" position="relative">
                        ...
                        <Grid xs={4}>
                            <Box display="flex" alignItems="center" justifyContent="center" height="415px" marginRight="10px" overflow="hidden" borderRadius="10px" position="relative" >
                        ...
                        <Grid xs={4}>
                            <Box display="flex" alignItems="center" justifyContent="center" height="380px" marginLeft="10px" marginRight="10px" overflow="hidden" borderRadius="10px" marginTop="-50px" position="relative" >
                        ...
                        <Grid xs={4}>
                            <Box display="flex" alignItems="center" justifyContent="center" height="420px" marginLeft="10px" overflow="hidden" borderRadius="10px" marginTop="-50px" position="relative" >
