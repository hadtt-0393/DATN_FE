...
export default function CommentComponent({ open, onClose, item }: any) {
    ...
    const [service, setServcie] = useState(0)
    ...
    //       `${process.env.REACT_APP_API_ENDPOINT}/form/getCommentByUser/${item}`,
    //       {
    //         service,
    //         cleanliness,
    //         comfortable,
